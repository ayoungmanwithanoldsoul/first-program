...
public class StandardNotNormalDistribution extends JFrame {
    ...
    public static void main(String[] args)
    {
        SwingUtilities.invokeLater(new Runnable()
        {
            public void run()
            {
                try
                {
                    new StandardNotNormalDistribution().setVisible(true);
                }
                catch (Exception exp)
                {
                }
    ...
    protected void StandardNotNormalDistribution()
    {
